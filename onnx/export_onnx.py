...
if __name__ == '__main__':
    ...
    torch.onnx.export(
        ...
        # dynamic_axes = {'input': {0: 'batch_size', 2: 'height', 3: 'width'}, 'output': {0: 'batch_size', 2: 'height', 3: 'width'}}, opset_version=10)
        dynamic_axes = {'input': {}, 'output': {0: 'batch_size', 2: 'height', 3: 'width'}})
